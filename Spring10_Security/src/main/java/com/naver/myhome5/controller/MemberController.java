...
*/
@Controller
@RequestMapping(value="/member")//http://localhost:8088/myhome5/member/로 시작하는 주소 매핑
public class MemberController {
   ...
   public ModelAndView login(ModelAndView mv,
      ...
      if(readCookie != null) {
         ...
         mv.addObject("loginfail", session.getAttribute("loginfail")); //세션에 저장된 값을 한 번만 실행될 수 있도록 한다.
   ...
   //http://localhost:8088/myhome5/member/join
   //회원가입 폼이동
