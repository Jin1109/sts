$(function(){
   ...
   if (count != 0) { //댓글 갯수가 0이 아니면
      getList(1); // 첫 페에지의 댓글을 구해 옵니다. (한 페이지에 3개씩 가져옵니다.)
   }else {//댓글이 없는 경우
               ...
               success : function(rdata){
                  ...
                  if(rdata.listcount > 0) {
                     ...
                     $(rdata.list).each(function() {
                        ...
                        //XSS(Cross-Site Scripting):권한인 없는 사용자가 웹 사이트에 스크립트를 삽입하는 공격 기법
                        //이것을 방지 하기 위한 방법으로 2번 처럼 <td></td> 영역을 만든 뒤 3번에서 text() 안에
